...
<pre class="mermaid"> flowchart TD A[Game Executable Starts] --> B[Windows Loader Resolves Imports] B --> C[Local dinput8.dll Proxy Loaded] C --> D[Instrumentation Module Initializes] D --> E[Protection Module Initializes] E --> F[Entrypoint Execution Continues] </pre>
